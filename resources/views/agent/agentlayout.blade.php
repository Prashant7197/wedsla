        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo" style="height: auto;">
                    <a href="/agent/dashboard" class="app-brand-link m-auto ">
                ...
                <ul class="menu-inner py-1">
                    ...
                    {{-- <li class="menu-item active">
                        <a href="/agent/dashboard" class="menu-link">
                    ...
                    {{-- <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item">
                                <a href="/agent/change_password" class="menu-link">
                    ...
                    {{-- <li class="menu-item">
                        <a href="/agent/notification" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-crown"></i>
                            <div data-i18n="Boxicons">Notification</div>
                        </a>
                    </li> --}}
                    <li class="menu-item">
                        <a href="/agent/booking" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-crown"></i>
                            <div data-i18n="Boxicons">Booking</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="/agent/customer" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-crown"></i>
                            <div data-i18n="Boxicons">My Customer</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="/agent/addcustomer" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-crown"></i>
                            <div data-i18n="Boxicons">Add New Customer</div>
                        </a>
                    </li>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        ...
                                        @else
                                            <img src="/images/agent/{{ Auth::guard('agent')->user()->profile }}" alt
                                                class="w-px-40 h-auto rounded-circle" />
                                        @endif
                                    </div>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a class="dropdown-item" href="/agent/profile">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span
                                                        class="fw-semibold d-block">{{ Auth::guard('agent')->user()->name }}</span>
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="/agent/change_password">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="/agent/logout">

            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo" style="height: auto;">
                    <a href="/admin" class="app-brand-link m-auto ">
                        <span class="app-brand-logo demo">
                            <img src="/images/icon/logo-trans.png" style="height:110px;" />
                        </span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="/agent/vendor" class="menu-link">
                                    <div data-i18n="Without navbar">All Vendor</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="/agent/vendor/create" class="menu-link">
                                    <div data-i18n="Without menu">Add new Vendor</div>
                                </a>
                            </li>
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="/agent/lawn" class="menu-link">
                                    <div data-i18n="Without navbar">All Lawn</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="/agent/lawn/create" class="menu-link">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="/agent/feedback" class="menu-link">
                                    <div data-i18n="Without navbar">All Feedback</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="/agent/feedback/create" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="/agent/enquery/" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="/agent/profile" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-crown"></i>
                            <div data-i18n="Boxicons">agent Profile</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="/agent/security" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-crown"></i>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <div class="avatar avatar-online">
                                        <img src="/agentpanel/assets/img/avatars/1.png" alt class="w-px-40 h-auto rounded-circle" />
                                    </div>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item" href="/agent/profile">
                                            <div class="d-flex">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="/agent/security">
                                            <i class="bx bx-cog me-2"></i>
                                            <span class="align-middle">Settings</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="/agent/billing">

...
@section('bodycontent')
    <div class="container-xl px-4 mt-4">
        ...
        <nav class="nav nav-borders">
            <a class="nav-link active ms-0" href="/agent/profile" >Profile</a>
            {{-- <a class="nav-link" href="/admin/billing" target="__blank">Billing</a> --}}
            <a class="nav-link" href="/agent/change_password" >Security</a>
        ...
        <div class="row">
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        @if (Auth::guard('agent')->user()->profile == null)
                            <img class="img-account-profile rounded-circle mb-2 img-fluid"
                                src="http://bootdey.com/img/Content/avatar/avatar1.png" alt>
                        @else
                            <img class="img-account-profile rounded-circle mb-2 img-fluid"
                                src="/images/agent/{{Auth::guard('agent')->user()->profile}}" alt>
                        @endif
                        <div class="small font-italic text-muted mb-4">JPG or PNG no larger than 5 MB</div>
                        <form action="/agent/update_profile" enctype="multipart/form-data" id="profile_image" method="POST"
                            style="display: none;">
                            @csrf
            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="/agent/update" method="post">
                            @csrf
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="inputUsername" type="text" name="email" disabled
                                    placeholder="Enter your username" value="{{ Auth::guard('agent')->user()->email }}">
                            </div>
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="inputFirstName" type="text" name="name"
                                        placeholder="Enter your full name" value="{{ Auth::guard('agent')->user()->name }}">
                                </div>
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="inputOrgName" type="text" name="position"
                                        placeholder="Enter your organization Post" value="{{ Auth::guard('agent')->user()->designation }}">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="inputPhone" type="tel" name="mobile"
                                        placeholder="Enter your phone number" value="{{ Auth::guard('agent')->user()->contact }}">
                                </div>
                            </div>
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="inputLocation" type="text" name="address"
                                        placeholder="Enter your address" value="{{ Auth::guard('agent')->user()->address }}">
                                </div>

            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="post" action="/vendor/change_password" id="change_paas">
                            @csrf
                            ...
                            <button class="btn btn-primary" type="button"
                                onclick="if(document.getElementById('newPassword').value==document.getElementById('confirmPassword').value)document.getElementById('change_paas').submit();">Save</button>
                        </form>
                    </div>
                </div>
